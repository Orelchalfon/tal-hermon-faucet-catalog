...
const configs = [
  ...
  {
    id: "all-in-one",
    title: "ברז נלווה קר + סודה",
    placeholder: "תמונה של ברז נלווה קר + סודה",
  ...
  {
    id: "tall-spout",
    title: "ברז גבוה לסיר ולקנקן",
    placeholder: "תמונת ברז מזיגה גבוה למילוי סירים וקנקנים",
    description:
      "ברז עם פיה גבוהה שמאפשרת מילוי נוח של סירים, קנקנים ובקבוקים גדולים.",
    benefits: [
      "פיה גבוהה במיוחד",
      "סיבוב 360 מעלות",
      "נוחות מרבית בשימוש יומיומי",
    ],
  },
  {
    id: "pull-out",
    title: "ברז נשלף עם מזיגת סודה",
    placeholder: "תמונת ברז עם פיה נשלפת ומזיגת סודה",
    description:
      "ברז משולב עם פיה נשלפת לשטיפת כלים יחד עם מזיגת מים קרים וסודה ישירות מהברז.",
    benefits: [
      "פיה נשלפת לשטיפה גמישה",
      "שני מצבי זרימה",
      "פתרון משולב חוסך מקום",
    ],
  },
  {
    id: "designer-arc",
    title: "ברז דיזיין קשתי לסודה",
    placeholder: "תמונת ברז דיזיין בעיצוב קשתי לסודה ומים קרים",
    description:
      "ברז בעיצוב קשתי ייחודי שמשלב אסתטיקה גבוהה עם מזיגת סודה ומים קרים מסוננים.",
    benefits: [
      "עיצוב קשתי בולט",
      "מתאים למטבחי בוטיק",
      "גימור פרימיום",
